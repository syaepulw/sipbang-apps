<!-- Navbar -->
<div class="w-full border-b border-dashed p-5" style="background-color: #2f3e46; border-color: #84a98c;">

    <div class="container mx-auto">
        <div class="flex justify-between items-center">
            <a href="/" class="flex items-center gap-2">
                <img src="{{ asset('warehouse.png') }}" class="w-7 h-7 object-center object-cover" />
                <h1 class="text-white text-2xl font-semibold">Inventaris Pengadaan Barang</h1>
            </a>
